...
namespace dotnetupgrade
{
    ...
    /// </summary>
    public class GcpAspNetMvcUpdaterServiceProvider : IExtensionServiceProvider
    {
        /// <summary>
        ...
        public IServiceCollection AddServices(ExtensionServiceConfiguration serviceConfiguration)
        {
            ...
            serviceConfiguration.ServiceCollection.AddTransient<DiagnosticAnalyzer, HttpStatusCodeResultAnalyzer>();
            serviceConfiguration.ServiceCollection.AddTransient<CodeFixProvider, HttpStatusCodeResultCodeFix>();

            serviceConfiguration.ServiceCollection.AddTransient<DiagnosticAnalyzer, PagedListAnalyzer>();
            serviceConfiguration.ServiceCollection.AddTransient<CodeFixProvider, PagedListCodeFix>();
